...
turtles-own [
  mkt profit growth-rate coop-with-same? coop-with-diff? average-growth-rate history
...
to setup-firms
  ...
  create-ethnos initial-number-ethnos [
   ...
   set profit median (list .5(random-normal 10 3)20)
...
;to update-node-appearance
 ; set size 0.1 + 5 * sqrt (mkt) ;; firm size changes w/ shift in mkt. share
;end
