...
turtles-own [mkt culture growth-rate]  ;; Market share, culture, firm growth rate
...
to setup-firms
  crt initial-number-ethnos [
   ...
   set color blue
   set shape "dot"
   ;set mkt (total-mkt / ? ) ;; Need to figure out how to make this dynamic/reference-dependent
